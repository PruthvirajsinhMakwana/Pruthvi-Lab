...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      "dark:data-[state=unchecked]:bg-muted dark:data-[state=checked]:bg-primary",
      "dark:data-[state=checked]:shadow-[0_0_16px_hsl(var(--primary-glow)/0.6)]",
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        ...
        "data-[state=checked]:shadow-[0_0_8px_hsl(var(--primary)/0.4)]",
      )}
    />
  </SwitchPrimitives.Root>
));
